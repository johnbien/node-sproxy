...
var definers  = require('./schema').definers;
...
this.Resource.filter = require('./resource/view').filter;
this.Resource.parent = require('./resource/relationship').parent;
this.Resource.child  = require('./resource/relationship').child;
